        ...
        facts: [
          {
            ...
            body: '<p>Yes, I know it says so on your card, but you could continue using it after the expiration date. Ever notice how the number on your replacement card is the same? The expiration date on your card fills two main purposes. First, it is an estimate of the lifetime of your credit card and gives your credit card issuer a date to send you a new card. Second, it is used for online and over-the-phone purchases when the merchant cannot see your card. Asking for the expiration date allows the merchant to confirm you are the owner of the card and have it in your possession.</p>'
          },
          {
            title: 'There are enough credit cards in circulation to span the earth over 3.5 times.',
            body: '<p>According to the financial reports of the three largest credit card companies in the world, there were over 1,635 million cards in circulation in 2013: Visa had 800 million, MasterCard had 731 million, and American Express had 104 million. If you placed all those cards side by side, you could span 86,981 miles: the equivalent of three and a half trips around the world.</p>'
          },
          {
